...
public class QueryCompany extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conditions.equals("")){
            ...
            strSQL = "and (CompanyName like '%"+conditions+"%' or CompanyTel like '%"+conditions+"%')";
        }
        ...
        sql = "SELECT  * FROM px_CRM_Company " +
        ...
        //查询表单数据数量
        String countSQL = "select count(*) from px_CRM_Company where 1=1"+strSQL;
        try {
...
//                System.out.println(SQLstate);
                ...
                try {
                    ...
                    while (os.next()) {
                        ...
                        data.add(os.getString("CompanyName"));
                        data.add(os.getString("CompanyTel"));
                        listData.add(data);
                        i++;
                    }
