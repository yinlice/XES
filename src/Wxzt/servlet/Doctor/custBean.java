...
public class custBean {
    ...
    private String custName;//医生姓名
    private String text01;// 登录名
    private String idnum;//身份证号码
    private String text02;//所在科室
    private String job;//行政职称
    private String text04;//学术职称
    private String text06;//简介
    private String text07;//擅长
    private String select04;//是否上传头像
    private String select05;//接入类型
    private String text09;// 医生ID
    private String mobile;//手机号码
    private String qq;//QQ
    private String weixin;//微信
    private String email;//邮箱
    private String dtCreate;//注册时间
    private String text10;//认证提交时间
    private String text11;//审核时间
    private String select03;//是否上传身份证
    private String text13;//资质证书
    private String text14;//注册渠道
    private String select01;//医生账户状态
    private String select02;//审核状态

    private String addr;//医院名称

    private String text17;//医院等级
    private String custType;//医生标签
    private String custFrom;//平台类型
    private String custNature;//医院状态
    private String text15;//问诊开通
    private String text16;//基础功能
    private String dtInvest;//注册时间
