 ...
 */
public class queryCustHeadTP extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("------------------queryCustHeadTP");
    ...
    public Object getCustSQL(HttpServletRequest request,String action) {
        ...
        if (Objects.equals(action, "0")) {
            return chtp.custHeadTPQuery(request);
        } else if (Objects.equals(action, "1")) {
            return chtp.custHeadTPOneQuery(request);
        }
        return null;
    }
}
