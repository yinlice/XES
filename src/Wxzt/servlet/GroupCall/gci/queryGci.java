 ...
 */
public class queryGci extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        queryJson jsonData = (queryJson) getGciSQL(request, action);
        //设置table表头信息
    ...
    /*action:0为查询页面*/
    public Object getGciSQL(HttpServletRequest request,String action) {
        gciSql sql = new gciSql();
        if (Objects.equals(action, "0")) {
            return sql.gciQuery(request);
        }
        return null;
    }
}
